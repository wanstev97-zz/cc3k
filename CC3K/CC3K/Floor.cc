...
Item*** Floor::itemFloor=(new Item*[25][79]); //take out the thereFloors if time
for (int y=0; y<25; y++)
{
  for (int x=0; x<79 x++)
  {
...
bool** Floor::itemThereFloor=(new bool[25][79]);
for (int y=0; y<25; y++)
{
  for (int x=0; x<79 x++)
  {
...
bool** Floor::enemyThereFloor=(new bool[25][79]);
for (int y=0; y<25; y++)
{
  for (int x=0; x<79 x++)
  {
...
void dropTreasureAt(int row,int col, Treasure* droppedTreasure)
{
  itemThereFloor[row][col]=true;
